      ...
      <div className="bg-gray-900 py-24">
        <div className="container mx-auto items-center justify-between">
          ...
          <div className="flex gap-4 mt-8 md:mt-12 items-center">
            <a href="/about" className="text-lg font-bold text-gray-900 hover:underline mr-6 bg-amber-500 px-5 py-2">
              Installation Guide
            </a>
            <a href="/about" className="text-lg font-bold text-amber-500 hover:underline ml-6">
              Documentation
            </a>
          </div>
        </div>
            ...
            <div className="w-full p-4 order-2 md:order-1">
              <div className="flex items-center justify-center h-full">
                <div>
                  ...
                  <div className="text-gray-900">
                    <p className="mt-3"><span className="text-amber-500">Tetrocache</span> is designed for effortless integration into <span className="text-amber-500">any environment.</span></p>
                    ...
                    <p className="mt-3">Accessible over a Unix socket, <span className="text-amber-500">Tetrocache</span> eliminates the need for complex security configurations while still ensuring seamless communication.</p>
                    <p className="mt-3">Whether you're working with <span className="text-amber-500">local or distributed</span> systems, <span className="text-amber-500">Tetrocache</span> can be easily plugged into your existing setup, delivering high performance without the hassle.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full p-4">
              <div className="flex items-center justify-center h-full">
                <div>
                  ...
                  <div className="text-gray-900">
                    <p className="mt-3"><span className="text-amber-500">Tetrocache</span> is fully <span className="text-amber-500">open-source</span>, giving you complete control to adjust and optimize it for any system or use case. </p>
                    ...
                    <p className="mt-3">Whether you're looking to tweak performance or add new features, <span className="text-amber-500">Tetrocache</span> offers the freedom and transparency to make it your own.</p>
                  </div>
                </div>
              </div>
            </div>
