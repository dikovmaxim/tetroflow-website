              ...
              <div className="flex items-center justify-center h-full">
                <div>
                  ...
                  <div className="text-gray-900">
                    <p className="mt-3"><span className="text-amber-500">Tetracache</span> is built in modern <span className="text-amber-500">C++</span> for <span className="text-amber-500">nanosecond</span> response times, using in-memory storage and a specialized <span className="text-amber-500">hashmap</span> to handle data types like lists, strings, etc. with ease.</p>
                    ...
                    <p className="mt-3"><span className="text-amber-500">Tetracache</span> delivers both speed and efficiency, making it ideal for <span className="text-amber-500">high-performance</span> environments.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full p-4 order-2 md:order-1">
              <div className="flex items-center justify-center h-full">
                <div>
                  ...
                  <div className="text-gray-900">
                    <p className="mt-3"><span className="text-amber-500">Tetracache</span> is designed for effortless integration into <span className="text-amber-500">any environment.</span></p>
                    ...
                    <p className="mt-3">Accessible over a Unix socket, <span className="text-amber-500">Tetracache</span> eliminates the need for complex security configurations while still ensuring seamless communication.</p>
                    <p className="mt-3">Whether you're working with <span className="text-amber-500">local or distributed</span> systems, <span className="text-amber-500">Tetracache</span> can be easily plugged into your existing setup, delivering high performance without the hassle.</p>
                  </div>
                </div>
              </div>
            </div>
            ...
            <div className="w-full p-4">
              <div className="flex items-center justify-center h-full">
                <div>
                  ...
                  <div className="text-gray-900">
                    <p className="mt-3"><span className="text-amber-500">Tetracache</span> is fully <span className="text-amber-500">open-source</span>, giving you complete control to adjust and optimize it for any system or use case. </p>
                    ...
                    <p className="mt-3">Whether you're looking to tweak performance or add new features, <span className="text-amber-500">Tetracache</span> offers the freedom and transparency to make it your own.</p>
                  </div>
                </div>
              </div>
            </div>
