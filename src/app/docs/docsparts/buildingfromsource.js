    ...
    return (
        <div>
            ...
            <p className="text-gray-500 my-4">
                Tetracache, as mentioned, is an open-source project, thus can be buit directly from source or be customized, if needed.
            </p>
            <div className="text-gray-500 my-4">
                To build Tetracache from source, you need to have the following dependencies installed: <br />
                ...
                <ol className="list-decimal text-gray-500 ml-6 space-y-4">
                    <li>
                        Clone the repository: <code><CopyBox value="git clone https://github.com/dikovmaxim/tetracache.git"/> </code>
                    </li>
                    <li>
                    ...
                    <li>
                        ...
                        <code><CopyBox value="./Tetracache"/> </code>
                    </li>
                </ol>
                <p className="text-gray-500 my-4">
