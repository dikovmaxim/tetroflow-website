    ...
    return (
        <div id="datatypes">
            ...
            <div className="text-gray-500 my-1">
                As mentioned earlier, Tetracache is a key-value store. It supports a variety of data types, but unlike other key-value stores, for example Redis, it has a "stromgly typed" approach to data storage.
                ...
                <br/>
                <br/>
                The following are the main data types supported by Tetracache:
            </div>
            <div className="my-6" id="datatype-strings">
                <p className="text-gray-500 text-lg font-bold">1. Strings</p>
                <div className="text-gray-500 my-1">
                    Strings are one of the basic data types in tetracache. They are stored as <CodeBlock>std::string</CodeBlock>, with a custom wrapper <CodeBlock>String</CodeBlock> to provide additional functionality, 
            ...
            <div className="my-6" id="datatype-sortedsets">
                <p className="text-gray-500 text-lg font-bold">8. Sorted sets</p>
                <div className="text-gray-500 my-1">
                    Sorted sets are stored as <CodeBlock>std::set&lt;std::shared_ptr&lt;DataType&gt;&gt;</CodeBlock> and are wrapped in a <CodeBlock>SortedSet</CodeBlock> class, which is defined in <CodeBlock>src/datatypes/SortedSet.hpp</CodeBlock> header file.<br/>
                    They are pretty similar to sets, but they are always sorted by the key. Requesting a sorted set with a <CodeBlock>GET</CodeBlock> command will as well return a json array with unique elements sorted by their content.<br/>
                </div>
            </div>
        </div>
    );
